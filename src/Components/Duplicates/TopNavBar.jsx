        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="mr-auto">
            ...
            <Nav.Link className="d-flex flex-column justify-content-center align-items-center small-inlink">
              ...
              <span className="nav-link-span text-nowrap">My network</span>
            </Nav.Link>
            ...
            <Nav.Link className="d-flex flex-column justify-content-center align-items-center small-inlink">
              ...
              <span className="nav-link-span">Jobs</span>
            </Nav.Link>
            ...
            <Nav.Link className="d-flex flex-column justify-content-center align-items-center small-inlink">
              ...
              <span className="nav-link-span">Messaging</span>
            </Nav.Link>
            ...
            <Nav.Link className="d-flex flex-column justify-content-center align-items-center position-relative small-inlink">
              ...
              <span className="nav-link-span">Notifications</span>
            ...
            >
              ...
              >
                ...
                <div className="d-flex align-items-center">
                  <span className="mr-1 nav-link-span">Me</span>
